...
def network_preprocess(G, temp_G, node_list, dir_, dataset, percent, criteria):
	prefix = 'weakties_%s_%sp_%s'%(dataset, percent, criteria)
	...
	node_list = sorted([n for n  in node_list if n not in top_nodes])
